...
const rollScenes = () => {
    ...
    for (let i = 0; i < lis.length; i++) {
        ...
        setTimeout(function () {
            bg.style.cssText = "filter: brightness(95%)";
            box.style.cssText = "filter: brightness(92.5%);box-shadow: 0 0 7px 3px inset khaki";
            bt.style.cssText = "opacity:0.3";
            pas1.style.cssText = "opacity:0.3";
            pas2.style.cssText = "opacity:0.3";
            pas3.style.cssText = "opacity:0.3";
            pas4.style.cssText = "opacity:0.3";
        }, 350)
        setTimeout(function () {
        ...
        setTimeout(function () {
            bg.style.cssText = "filter: brightness(85%)";
            box.style.cssText = "filter: brightness(97.5%);box-shadow: 0 0 12px 5px inset khaki";
            bt.style.cssText = "opacity:0.5";
            pas1.style.cssText = "opacity:0.5";
            pas2.style.cssText = "opacity:0.5";
            pas3.style.cssText = "opacity:0.5";
            pas4.style.cssText = "opacity:0.5";
        }, 450)
        setTimeout(function () {
        ...
        setTimeout(function () {
            bg.style.cssText = "filter: brightness(72%)";
            box.style.cssText = "filter: brightness(105%);box-shadow: 0 0 17px 7px inset khaki";
            bt.style.cssText = "opacity:0.7";
            pas1.style.cssText = "opacity:0.7";
            pas2.style.cssText = "opacity:0.7";
            pas3.style.cssText = "opacity:0.7";
            pas4.style.cssText = "opacity:0.7";
        }, 550)
        setTimeout(function () {
        ...
        setTimeout(function () {
            bg.style.cssText = "filter: brightness(57%)";
            box.style.cssText = "filter: brightness(115%);box-shadow: 0 0 25px 9px inset khaki";
            bt.style.cssText = "opacity:0.9";
            pas1.style.cssText = "opacity:0.9";
            pas2.style.cssText = "opacity:0.9";
            pas3.style.cssText = "opacity:0.9";
            pas4.style.cssText = "opacity:0.9";
        }, 650)
        setTimeout(function () {
